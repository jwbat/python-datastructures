...
class Tree:
    ...
    def contains(self, num):
        def _contains(root, num):
            ...
            return _contains(root.left, num) | \
                    _contains(root.right, num)

        return _contains(self.root, num)
    ...
    def get_nodes_at_distance(self, k):
        ...
        def _dist(root, k):
            ...
            return _dist(root.left, k - 1), _dist(root.right, k - 1)
